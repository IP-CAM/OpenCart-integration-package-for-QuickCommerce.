<?php
class ControllerProductDigital extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($product_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/digital.tpl')) {
				$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/product/digital.tpl', $data));
			} else {
				$this->response->setOutput($this->load->view('default/template/product/digital.tpl', $data));
			}
		} else {
			$url = '';
