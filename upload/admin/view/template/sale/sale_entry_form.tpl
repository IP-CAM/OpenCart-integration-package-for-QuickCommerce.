...
<div id="content">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form class="form-horizontal">
					<ul id="sale" class="nav nav-tabs nav-justified">
					...
					<div class="tab-content">
							...
							<?php foreach ($custom_fields as $custom_field) { ?>
								<?php if ($custom_field['location'] == 'account') { ?>
									<?php if ($custom_field['type'] == 'select') { ?>
										<div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_sale'] + 3; ?>">
						...
						<div class="tab-pane" id="tab-cart">
							<div class="table-responsive">
								<table class="table table-bsaleed">
									...
									<tbody id="cart">
										<?php if ($sale_products || $sale_vouchers) { ?>
											<?php $product_row = 0; ?>
											<?php foreach ($sale_products as $sale_product) { ?>
												<tr>
													<td class="text-left">
														<input id="name-<?php echo $product_row; ?>" type="text" name="product[<?php echo $product_row; ?>][name]" value="<?php echo $sale_product['name']; ?>" class="form-control" />
														<input id="product-<?php echo $product_row; ?>" type="hidden" name="product[<?php echo $product_row; ?>][product_id]" value="<?php echo $sale_product['product_id']; ?>" />
													</td>
													<?php if ($product_column_option) { ?>
														<td class="text-left">
															<?php foreach ($sale_product['option'] as $option) { ?>
													...
													<?php } ?>
													<td class="text-left">
														<input id="model-<?php echo $product_row; ?>" type="text" name="product[<?php echo $product_row; ?>][model]" value="<?php echo $sale_product['model']; ?>" class="form-control" />
													</td>
													<td class="text-right">
														<input id="quantity-<?php echo $product_row; ?>" style="text-align:right;" type="text" name="product[<?php echo $product_row; ?>][quantity]" value="<?php echo $sale_product['quantity']; ?>" class="form-control" />
													</td>
													<?php if ($product_column_price) { ?>
														<td class="text-right">
															<input id="price-<?php echo $product_row; ?>" style="text-align:right;" type="text" name="product[<?php echo $product_row; ?>][price]" value="<?php echo $sale_product['price']; ?>" class="form-control" />
														</td>
													<?php } else { ?>
														<input id="price-<?php echo $product_row; ?>" type="hidden" name="product[<?php echo $product_row; ?>][price]" value="<?php echo $sale_product['price']; ?>" />
													<?php } ?>
													<?php if ($product_column_total) { ?>
													...
													<?php } else { ?>
														<input id="notax-<?php echo $product_row; ?>" type="hidden" name="product[<?php echo $product_row; ?>][notax]" value="<?php echo $sale_product['notax']; ?>" />
													<?php } ?>
													<?php if ($product_column_pricet) { ?>
														<td class="text-right"></td>
													<?php } ?>
											...
											<?php } ?>
											<?php $voucher_row = 0; ?>
											<?php foreach ($sale_vouchers as $sale_voucher) { ?>
												<tr>
													<td class="text-left">
														<?php echo $sale_voucher['description']; ?>
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][voucher_id]" value="<?php echo $sale_voucher['voucher_id']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][description]" value="<?php echo $sale_voucher['description']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][code]" value="<?php echo $sale_voucher['code']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][from_name]" value="<?php echo $sale_voucher['from_name']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][from_email]" value="<?php echo $sale_voucher['from_email']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][to_name]" value="<?php echo $sale_voucher['to_name']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][to_email]" value="<?php echo $sale_voucher['to_email']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][voucher_theme_id]" value="<?php echo $sale_voucher['voucher_theme_id']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][message]" value="<?php echo $sale_voucher['message']; ?>" />
														<input type="hidden" name="voucher[<?php echo $voucher_row; ?>][amount]" value="<?php echo $sale_voucher['amount']; ?>" />
													</td>
													<?php if ($product_column_option) { ?>
						...
						<div class="tab-pane" id="tab-total">
							...
							<fieldset>
								<legend><?php echo $text_sale; ?></legend>
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-sale-status"><?php echo $entry_sale_status; ?></label>
									<div class="col-sm-10">
										<select name="sale_status_id" id="input-sale-status" class="form-control">
											<?php foreach ($sale_statuses as $sale_status) { ?>
												<?php if ($sale_status['sale_status_id'] == $sale_status_id) { ?>
										...
										<input type="hidden" name="temp_sale_id" value="" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group required">
									...
									<div class="col-sm-10">
										<input type="hidden" name="sale_balance" value="<?php echo $sale_balance; ?>" />
	...
	<script type="text/javascript"><!--
		// Disable the tabs
		$('#sale a[data-toggle=\'tab\']').on('click', function(e) {
			return false;
		});
		var typingTimer;
		...
		$('#tab-cart').delegate('.btn-default', 'click', function() {
			...
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/cart/edit',
				type: 'post',
				dataType: 'json',
				data: post_data,
		...
		$('#button-refresh').on('click', function() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/cart/products&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				dataType: 'json',
				success: function(json) {
					$('.alert-danger, .text-danger').remove();
					// Check for errors
					...
					$('#total').html(html);
					$('input[name=\'sale_balance\']').val(json['balance']);
				},
				error: function(xhr, ajaxOptions, thrownError) {
					alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
				}
		...
		$('select[name=\'currency\']').on('change', function() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/currency&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
		...
		$('#button-customer').on('click', function() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/customer&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
				...
				success: function(json) {
					...
					if (json['error']) {
						...
						$.ajax({
							url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/cart/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
							type: 'post',
						...
						$.ajax({
							url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/voucher/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
							type: 'post',
						...
						$.ajax({
							url: 'index.php?route=sale/sale_entry/checkEmail&token=<?php echo $token; ?>&email=' + encodeURIComponent($('input[name=\'email\']').val()),
							type: 'GET',
							dataType: 'json',
							success: function(json) {
								if (json == 'exists') {
		...
		$('#tab-cart').delegate('.btn-danger', 'click', function() {
			...
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/cart/remove&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
		...
		$('#tab-payment select[name=\'country_id\']').on('change', function() {
			$.ajax({
				url: 'index.php?route=sale/sale/country&token=<?php echo $token; ?>&country_id=' + this.value,
				dataType: 'json',
				beforeSend: function() {
		...
		$('#button-payment-address').on('click', function() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/payment/address&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
				...
				success: function(json) {
					...
					if (json['error']) {
						...
						// Payment Methods
						$.ajax({
							url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/payment/methods&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
							dataType: 'json',
							beforeSend: function() {
		...
		$('#button-shipping-address').on('click', function() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/shipping/address&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
				...
				success: function(json) {
					...
					if (json['error']) {
						...
						// Shipping Methods
						$.ajax({
							url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/shipping/methods&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
							dataType: 'json',
							beforeSend: function() {
		...
		$('#input-shipping-method').on('change', function() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/shipping/method&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
		...
		$('#input-payment-method').on('change', function() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/payment/method&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
		...
		function processCoupon() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/coupon&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
		...
		function processVoucher() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/voucher&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
		...
		function processReward() {
			$.ajax({
				url: 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/reward&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
				type: 'post',
		...
		$('#button-save').on('click', function() {
			...
			if (sale_id == 0) {
				var url = 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/sale/add&store_id=' + $('select[name=\'store_id\'] option:selected').val();
			} else {
				var url = 'index.php?route=sale/sale/api&token=<?php echo $token; ?>&api=api/sale/edit&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&sale_id=' + sale_id;
			}
			$.ajax({
				url: url,
				type: 'post',
				data: $('#tab-total select[name=\'sale_status_id\'], #tab-total select, #tab-total textarea[name=\'comment\'], #tab-total input[name=\'affiliate_id\']'),
				dataType: 'json',
				beforeSend: function() {
