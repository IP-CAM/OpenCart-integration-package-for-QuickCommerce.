              ...
              <div class="table-responsive">
                <table class="table table-bsaleed">
                  ...
                  <tbody id="cart">
                    ...
                    <tr>
                      <td class="text-left"><?php echo $sale_product['name']; ?><br />
                        <input type="hidden" name="product[<?php echo $product_row; ?>][product_id]" value="<?php echo $sale_product['product_id']; ?>" />
                        ...
                        <?php } ?>
                        <?php } ?></td>
                      <td class="text-left"><?php echo $sale_product['model']; ?></td>
                      <td class="text-right"><?php echo $sale_product['quantity']; ?>
                        <input type="hidden" name="product[<?php echo $product_row; ?>][quantity]" value="<?php echo $sale_product['quantity']; ?>" /></td>
                    ...
                    <tr>
                      <td class="text-left"><?php echo $sale_voucher['description']; ?>
                        ...
                        <input type="hidden" name="voucher[<?php echo $voucher_row; ?>][amount]" value="<?php echo $sale_voucher['amount']; ?>" /></td>
