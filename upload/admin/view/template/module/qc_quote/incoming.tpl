<table id="ordersWrapper<?php echo $store_id; ?>" class="table table-bordered table-hover" width="100%">
    <thead>
        <tr class="table-header">
            ...
            <th width="24%"><?php echo $table_custnotes; ?></th>
            <th width="10%"><?php echo $table_date; ?></th>
            <th width="6%"><?php echo $table_actions; ?></th>
        </tr>
    </thead>
    <tbody>
        <?php foreach($sources as $source) { ?>
        	<tr>
        		...
        		<td>
                	<a onclick="moveCustomer('<?php echo $source['callforprice_id']; ?>')" class="btn btn-primary" title="<?php echo $button_move; ?>" tooltip="<?php echo $button_move; ?>"><i class="fa fa-share"></i></a> <a onclick="removeCustomer('<?php echo $source['callforprice_id']; ?>')" style="margin-top:3px;" class="btn btn-danger" title="<?php echo $button_remove; ?>" tooltip="<?php echo $button_remove; ?>"><i class="fa fa-times"></i></a>
                </td>
       		</tr>
        <?php } ?>
	</tbody>
...
<div style="float:right;padding: 5px;">
	<a onclick="moveAll()" class="btn btn-info"><i class="fa fa-share"></i>&nbsp;&nbsp;<?php echo $button_moveall; ?></a>
	<a onclick="removeAll()" class="btn btn btn-warning"><i class="fa fa-trash"></i>&nbsp;&nbsp;<?php echo $button_removeall; ?></a>
</div>
