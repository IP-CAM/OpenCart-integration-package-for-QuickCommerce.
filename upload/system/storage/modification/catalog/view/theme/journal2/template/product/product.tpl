...
<div id="container" class="container j-container">
  ...
  <div class="row">
    ...
    <div id="content" class="product-page-content" itemscope itemtype="http://schema.org/Product">
      ...
      <h1 class="heading-title" itemprop="name"><?php echo implode(' ', array($manufacturer, $heading_title)); ?></h1>
      <?php endif; ?>
          ...
          <?php } ?>
            <div class="form-group cart <?php echo isset($labels) && is_array($labels) && isset($labels['outofstock']) ? 'outofstock' : ''; ?>">
              ...
              <script>
                ...
                <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="button"><span class="button-cart-text">
                ...
                <div class="product-details">
                  ...
                  <div class="button-group">
                    ...
                    <div class="cart <?php echo isset($product['labels']) && is_array($product['labels']) && isset($product['labels']['outofstock']) ? 'outofstock' : ''; ?>">
                      <a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button hint--top" data-hint="
